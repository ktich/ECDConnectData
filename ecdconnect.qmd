...
**17%** of users who signed up 30+ days ago returned to the app within the past 30 days. This is higher than the standard [global app retention rate of 7% by day 30](https://www.adjust.com/resources/guides/user-retention/).
...
#| fig-cap: "Gender distribution of children"
#| warning: false
#| message: false
...
coord_polar(theta = "y") +
labs(title = "Gender distribution of children") +
theme_void() +
...
#| fig-cap: "Number of children by age group"
#| warning: false
#| message: false
...
labs(title = "Number of children by age group",
x = "Age Group",
...
_More demographics graphs to be added_
...
ggplot() +
  ...
  labs(
    title = "Total Preschool Income and Expenses",
    subtitle = "Total income vs expenses per month across all preschools",
    x = "Month",
    y = "Amount (R)",
    fill = ""
  ) +
...
combined <- subplot(p1, p2, widths = c(0.5, 0.5)) %>%
  layout(
    margin = list(b = 120, t = 20),  # add bottom space
    annotations = list(
      list(
        text = "Income Types",
