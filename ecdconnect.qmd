...
**About the report:** this report (as of 20 November 2025) provides an overview of ECD Connect’s reach, usage, and key emerging data insights across both education and health. It highlights early patterns from our dashboards, recent progress in how we share data with partners, and how these trends support programme quality and sector-wide learning. This report is for internal use at DGMT only and should not be shared externally.

***

## ECD Connect Data Progress

We have made strong progress in how we analyse and share data across both education and health. Partners now have clearer, actionable insights into uptake, delivery, and user behaviour.

- Dashboards now surface key patterns in retention, engagement, service delivery, and outcomes.
- App improvements have been made directly in response to emerging data signals.
- Data is increasingly linked to child outcomes, preschool delivery, referrals, and stunting.

These developments reinforce ECD Connect’s core purpose: a user-centred system that also delivers the insight and accountability needed for scale. As usage grows, it positions the sector to integrate partner datasets (ECD Connect, Funda App, etc.) with larger systems, ultimately contributing to South Africa’s shift toward a more coherent and coordinated ECD data ecosystem.
...
::: {.stat-card}
<p class="stat-number">12,831</p>
<p class="stat-label">total number of children registered</p>
:::
...
Pilots were conducted in 4 provinces over the past 2 years: Gauteng, Limpopo, Mpumalanga, and Western Cape. Pilots in Limpopo and Gauteng have ended and users will be deactivated in the near future.

### Visits Completed per Month (November 2024 to November 2025)
...
_Where "active CHW" = a user who has completed at least one visit in that month._
...
### Attendance registers saved
_[to be updated] We have seen increases in attendance tracking around partner organisation outreach efforts._
...
# --- Load required CSVs + spatial data (previously loaded in chunk 1) ---
codes <- read_csv("~/Desktop/data/codes-ed.csv")
load("~/Desktop/data/postalcodes_geo.rda")   # <-- this restores `postalcodes_geo`
